...
<div class="wrap dfr-settings-wrap">
    ...
    <!-- ========================================= -->
    <!-- ICON UPLOADS - SEPARATE SEKTION (außerhalb des Haupt-Forms) -->
    <!-- ========================================= -->
    
    <?php if (!empty($options['use_custom_icons'])) : ?>
    <div class="dfr-card" style="background:#fffbea;border-left:4px solid #ffc107;">
        <h2>📦 Icon-Uploads</h2>
        <p style="color:#856404;margin:0 0 20px;">Diese Sektion verwendet separate Forms und speichert Icons sofort nach Upload.</p>
        
        <div class="dfr-info-box" style="background:#fff3cd;border-left-color:#ffc107;margin:0 0 20px;">
        ...
        <!-- Thumbs Icons -->
        <div class="dfr-icons-section" style="padding:20px;background:white;border-radius:8px;margin-bottom:20px;">
            ...
            <div class="dfr-icon-upload-row">
                ...
                <div class="dfr-icon-actions">
                    ...
                    <?php if ($current_icon) : ?>
                    <form method="post" style="display:inline-block;margin-left:10px;" action="">
        ...
        <!-- Sterne Icons -->
        <div class="dfr-icons-section" style="padding:20px;background:white;border-radius:8px;">
            <h3 style="margin:0 0 20px;font-size:0.95rem;color:#666;text-transform:uppercase;letter-spacing:0.05em;">
                ⭐ Sterne-System Icons
            </h3>
    ...
    <form method="post" action="">
        ...
        <div class="dfr-card">
            ...
            <div class="dfr-field">
                ...
                <p class="description">Zeigt einen visuellen Balken mit der Verteilung der Bewertungen.</p>
            </div>
            
            <div class="dfr-field">
                <label>
                    <input type="checkbox" name="enable_schema" value="1" <?php checked(!empty($options['enable_schema'])); ?>>
                    Schema.org AggregateRating aktivieren
                </label>
                <p class="description">
                    Fügt strukturierte Daten für Suchmaschinen hinzu. Kann die Darstellung in Google-Suchergebnissen verbessern.
                </p>
            </div>
        </div>
        ...
        <!-- Spam-Schutz -->
        <div class="dfr-card">
            <h2>Spam-Schutz & Rate Limiting</h2>
            
            <div class="dfr-field">
                <label>Rate Limit (Minuten zwischen Bewertungen)</label>
                <input type="number" 
                       ...
                       style="width:100px">
                <p class="description">
                    Verhindert Spam durch zeitliche Begrenzung. 0 = deaktiviert. Standard: 60 Minuten.
                </p>
            </div>
            ...
            <div class="dfr-field">
                <label>
                    ...
                    E-Mail-Benachrichtigung bei negativem Feedback
                </label>
                <p class="description">Erhalte eine E-Mail wenn jemand negatives Feedback gibt.</p>
            </div>
            
            <?php if (!empty($options['email_alerts'])) : ?>
            <div class="dfr-field">
        ...
        <div class="dfr-card">
            ...
            <div class="dfr-field">
                ...
                <p class="description">
                    Lade deine eigenen Icons als SVG, PNG, JPG, GIF oder WebP hoch (max. 500KB pro Icon).<br>
                    <strong>Nach Aktivierung:</strong> Die Upload-Felder erscheinen oben auf dieser Seite in einer separaten Box.
                </p>
            </div>
        ...
        <div class="dfr-card">
            ...
            <div class="dfr-field">
                <label>Text: Positiv</label>
                <input type="text" name="text_pos" value="<?php echo esc_attr($options['text_pos'] ?? 'Hilfreich'); ?>" style="width:100%;max-width:300px">
            </div>
            
            <div class="dfr-field">
                <label>Text: Neutral</label>
                <input type="text" name="text_neu" value="<?php echo esc_attr($options['text_neu'] ?? 'Neutral'); ?>" style="width:100%;max-width:300px">
            </div>
            
            <div class="dfr-field">
                <label>Text: Negativ</label>
                <input type="text" name="text_neg" value="<?php echo esc_attr($options['text_neg'] ?? 'Nicht hilfreich'); ?>" style="width:100%;max-width:300px">
            </div>
            
            <div class="dfr-field">
                <label>Text: Wird gespeichert...</label>
                <input type="text" name="text_saving" value="<?php echo esc_attr($options['text_saving'] ?? 'Wird gespeichert...'); ?>" style="width:100%;max-width:300px">
            </div>
            
            <div class="dfr-field">
                <label>Text: Danke-Meldung</label>
            ...
            <div class="dfr-field">
                <label>Text: Bereits abgestimmt</label>
            ...
            <div class="dfr-field">
                <label>Text: Fehler-Meldung</label>
                <input type="text" name="text_error" value="<?php echo esc_attr($options['text_error'] ?? 'Fehler beim Speichern.'); ?>" style="width:100%;max-width:400px">
            </div>
            
            <div class="dfr-field">
                <label>Text: "hilfreich" (Statistik)</label>
                <input type="text" name="text_helpful_label" value="<?php echo esc_attr($options['text_helpful_label'] ?? 'hilfreich'); ?>" style="width:100%;max-width:200px">
            </div>
            
            <div class="dfr-field">
                <label>Text: "Bewertungen" (Statistik)</label>
                <input type="text" name="text_votes_label" value="<?php echo esc_attr($options['text_votes_label'] ?? 'Bewertungen'); ?>" style="width:100%;max-width:200px">
            </div>
            
            <div class="dfr-field">
                <label>Text: Noch keine Bewertungen</label>
                <input type="text" name="text_no_votes" value="<?php echo esc_attr($options['text_no_votes'] ?? 'Noch keine Bewertungen'); ?>" style="width:100%;max-width:400px">
            </div>
            
            <div class="dfr-field">
                <label>Text: Sei der Erste</label>
                <input type="text" name="text_be_first" value="<?php echo esc_attr($options['text_be_first'] ?? 'Sei der Erste!'); ?>" style="width:100%;max-width:300px">
            </div>
        </div>
        ...
        <div class="dfr-card">
            <h2>Custom CSS</h2>
            <p class="description" style="margin:0 0 15px;">Füge eigenes CSS hinzu um das Design weiter anzupassen.</p>
            
            <div class="dfr-field">
                <textarea name="custom_css" 
                          style="width:100%;height:200px;font-family:monospace;font-size:0.9rem;" 
                          placeholder=".dfr-feedback-container { /* Dein CSS */ }"><?php echo esc_textarea($options['custom_css'] ?? ''); ?></textarea>
                <p class="description">
                    <strong>Hinweis:</strong> CSS-Variablen sind verfügbar: --dfr-primary, --dfr-positive, --dfr-neutral, --dfr-negative, --dfr-radius
                </p>
            </div>
        </div>
